...
const zend_function_entry foo_functions[] = {
    PHP_FE(foo_counter_get, NULL)
    PHP_FE(foo_counter_incr, NULL)
    PHP_FE(foo_crc16, NULL)
    PHP_FE_END
};
...
PHP_MINFO_FUNCTION(foo)
{
    ...
    php_info_print_table_row(2, "foo version", PHP_FOO_VERSION);
